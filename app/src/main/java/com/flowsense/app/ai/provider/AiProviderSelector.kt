...
import com.flowsense.app.data.model.defaultModelIdFor
...
class AiProviderSelector(
    ...
    /**
     * Configures the cloud provider with the selected type and API keys.
     */
    fun configureCloud(
        providerType: CloudAiProviderType,
        claudeKey: String,
        geminiKey: String,
        openaiKey: String,
        deepseekKey: String,
